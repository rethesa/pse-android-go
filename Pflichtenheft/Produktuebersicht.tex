...
\begin{figure} [H]
	\includegraphics[scale =0.85]{resources/images/anwendungsfaelle/Anwendungsfalldiagramm.pdf}
	\centering
\end{figure}

\subsection{Wunschkriterien}
\begin{figure} [H]
	\includegraphics[scale=0.85]{resources/images/anwendungsfaelle/AnwendungsfalldiagrammWK.pdf}
	\centering
\end{figure}
